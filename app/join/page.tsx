...
//     steps: ["Member Type", "Personal Info", "Location", "Additional Info", "Confirmation"],
...
//     steps: ["सदस्य प्रकार", "व्यक्तिगत जानकारी", "स्थान", "अतिरिक्त जानकारी", "पुष्टिकरण"],
...
//     if (currentStep === 0 && !formData.memberType) {
//       newErrors.memberType = t.validation.required
//     }
...
//   const steps = [
//     // Step 0: Member Type
//     <div key="member-type" className="space-y-6">
//       <h2 className="text-2xl font-bold text-gray-800">{t.memberType}</h2>
//       {errors.memberType && (
//         <div className="text-red-500 text-sm">{errors.memberType}</div>
//       )}
//       <div className="grid grid-cols-1 gap-4">
//         {t.memberOptions.map((option) => (
//           <motion.label 
//             key={option} 
//             className={`flex items-center p-4 border rounded-xl hover:border-blue-400 transition-colors cursor-pointer ${
//               errors.memberType ? 'border-red-500' : 'border-gray-200'
//             }`}
...
//               name="memberType"
//               value={option}
//               checked={formData.memberType === option}
...
//             {language === "en" 
//               ? "Thank you for your interest in joining Aam Aadmi Party. Your information will help us serve you better."
//               : "आम आदमी पार्टी में शामिल होने में रुचि लेने के लिए धन्यवाद। आपकी जानकारी हमें आपको बेहतर सेवा प्रदान करने में मदद करेगी।"}
//           </p>
//         </div>
//       </div>
//     </div>,
