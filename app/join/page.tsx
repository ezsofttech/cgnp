...
const content = {
  en: {
    ...
    selectLokSabhaFirst: "Select Lok Sabha first",
    next: "Next",
    previous: "Previous",
    submit: "Submit",
  ...
  hi: {
    ...
    selectLokSabhaFirst: "पहले लोकसभा चुनें",
    next: "आगे",
    previous: "पीछे",
    submit: "जमा करें",
...
export function MemberRegistrationForm() {
  ...
  const validateCurrentStep = () => {
    ...
    if (currentStep === 0) { // Personal Info step
...
{/* email */}
    ...
    // Step 1: Location with dependent dropdowns
          ...
          {!formData.lokSabha && (
            <p className="text-sm text-gray-500">
              {language === "en" 
                ...
                : "कृपया पहले एक लोकसभा निर्वाचन क्षेत्र चुनें"}
            </p>
          )}
        </div>
