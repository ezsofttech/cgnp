...
import { LeaderRegistrationForm } from "@/components/forms/leader-registration-form"
      ...
      <main className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6 mb-12 text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">Join AAP Leadership</h1>
            <p className="text-xl text-aap-blue-100 max-w-3xl mx-auto leading-relaxed">
              Be part of the change you want to see. Register as an AAP leader and help us build a transparent,
              accountable government for the people.
            </p>
          ...
          <div className="text-center mt-8">
            <p className="text-aap-blue-100">
              ...
              <a href="/leader/login" className="text-aap-yellow-400 hover:text-aap-yellow-300 font-medium">
                Login here
              </a>
            </p>
          </div>
