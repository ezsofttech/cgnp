...
//   bio: z.string().min(10, "Bio must be at least 10 characters").max(500, "Bio cannot exceed 500 characters"),
//   role: z.enum([
//      "party_admin",              // ✅ Added new role here
//     "national_convenor",
//     "deputy_convenor",
//     "policy_head",
//     "organization_secretary",
...
// interface LeaderFormProps {
//   leader?: any
//   onSuccess?: (credentials?: LeaderCredentials) => void
// }
...
//         if (!isEditing) {
//           // For new leader creation, pass credentials to onSuccess
//           if (result.data) {
//             const credentials: LeaderCredentials = {
//               email: result.data.email,
//               password: data.password || result.data.temporaryPassword || "Password not returned",
//               referralCode: result.data.referralCode || "REF-" + Math.random().toString(36).substr(2, 9).toUpperCase(),
//               name: result.data.name
//             }
//             onSuccess?.(credentials)
//           } else {
//             // Fallback if API doesn't return data structure
//             const credentials: LeaderCredentials = {
//               email: data.email,
//               password: data.password || "Password not returned",
...
//           setSelectedPermissions([])
//         } else {
//           // For editing, just call onSuccess without credentials
//           onSuccess?.()
//         }
//       } else {
//         setSubmitStatus("error")
...
//   const roleOptions = [
//     { value: "party_admin", label: "Party Admin" }, // ✅ Added new role
//     { value: "national_convenor", label: "National Convenor" },
//     { value: "deputy_convenor", label: "Deputy Convenor" },
//     { value: "policy_head", label: "Policy Head" },
//     { value: "organization_secretary", label: "Organization Secretary" },
...
//     }
//   }
// // Automatically grant all permissions to Party Admin
// const handleRoleChange = (value: string) => {
//   setValue("role", value as any)
//   if (value === "party_admin") {
//     const allPermissions = permissionOptions.map((p) => p.id)
...
//         <div className="space-y-2">
//           <Label htmlFor="role">Leadership Role *</Label>
//           <Select onValueChange={handleRoleChange} defaultValue={leader?.role}>
//   <SelectTrigger className="border-gray-300 focus:border-blue-500">
//     <SelectValue placeholder="Select leadership role" />
//   </SelectTrigger>
//   <SelectContent>
